...
namespace std {
  ...
  public:
    ...
    @\added{constexpr}@ void splice(const_iterator position, forward_list& x);
    @\added{constexpr}@ void splice(const_iterator position, forward_list&& x);
    @\added{constexpr}@ void splice(const_iterator position, forward_list& x, const_iterator i);
    @\added{constexpr}@ void splice(const_iterator position, forward_list&& x, const_iterator i);
    @\added{constexpr}@ void splice(const_iterator position, forward_list& x, const_iterator first, const_iterator last);
    @\added{constexpr}@ void splice(const_iterator position, forward_list&& x, const_iterator first, const_iterator last);
...
@\added{constexpr}@ void splice(const_iterator position, forward_list& x, const_iterator first,
const_iterator last);
@\added{constexpr}@ void splice(const_iterator position, forward_list&& x, const_iterator first,
const_iterator last);
\end{itemdecl}
